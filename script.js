...
console.log(`Answer for first problem is :>>>> \n\nTest data 1 : i/p [5, 3, 9, 2, 7] o/p is --> ${rearrangeEvenOdd([5, 3, 9, 2, 7])}\n\nTest data 2 : i/p [10, -5, 0, 15, 20] o/p is --> ${rearrangeEvenOdd([10, -5, 0, 15, 20])}`);
...
console.log(`Answer for second problem is :>>>> \n\nTest data 1 : i/p [1, 2, 4, 5] o/p is --> ${findMissingNumber([1, 2, 4, 5])}\n\nTest data 2 : i/p [10, 7, 3, 5, 8, 1, 4, 6, 2] o/p is --> ${findMissingNumber([10, 7, 3, 5, 8, 1, 4, 6, 2])}`);
...
Test data 1 : i/p 10 o/p is --> ${decimalToBinary(10)}\n\nTest data 2 : i/p 25 o/p is --> ${decimalToBinary(25)}`);
...
Test data 1 : i/p "I love programming" o/p is --> ${longestWord("I love programming")}\n\nTest data 2 : i/p "JavaScript is awesome" o/p is --> ${longestWord("JavaScript is awesome")}`);
...
Test data 1 : i/p [2, 7, 11, 15] , 9 o/p is --> ${twoSum([2, 7, 11, 15], 9)}\n\nTest data 2 : i/p [3, 2, 4], 6 o/p is --> ${twoSum([3, 2, 4], 6)}`);
...
Test data 1 : i/p "abc" o/p is --> ${allCombinations("abc")}\n\nTest data 2 : i/p "dog" o/p is --> ${allCombinations("dog")}`);
